...
function setup_mdt_easy {
  ...
  io500_mdtest_easy_files_per_proc=150000
}

function setup_ior_hard {
  io500_ior_hard_writes_per_proc=28000
  io500_ior_hard_other_options="-E -a MPIIO" #e.g., -E to keep precreated files using lfs setstripe, or -a MPIIO
}

function setup_mdt_hard {
  io500_mdtest_hard_files_per_proc=120000
