...
# Use distributed_stream to test memory performance. Will need mxml library
# available somewhere for this to work.
# Question: should we take a copy of the source and host here or pull from 
# the repo?
