...
class BenchioMPIIOUCX16Nodes(BenchioMPIIOUCXBase):
    """BenchIOMPIIOUCX 16 nodes test class"""
...
class BenchioMPIIOUCXOpt16Nodes(BenchioMPIIOUCXBase):
    """BenchIOMPIIOUCX 16 nodes Opt test class"""
...
class BenchioMPIIOUCXOpt16NodesAllstripe(BenchioMPIIOUCXBase):
    """BenchIOMPIIOUCX 16 nodes stripe test class"""
    ...
    executable_opts = ("2048 2048 2048 global mpiio hdf5").split()
...
class BenchioMPIIOUCX32Nodes(BenchioMPIIOUCXBase):
    """BenchIOMPIIOUCX 32 nodes test class"""
    ...
    env_vars = {"OMP_NUM_THREADS": "1", "SRUN_CPUS_PER_TASK": "1"}

    executable_opts = ("4096 4096 4096 global mpiio hdf5 fullstriped fsync").split()
...
class BenchioMPIIOUCXOpt32Nodes(BenchioMPIIOUCXBase):
    """BenchIOMPIIOUCX 32 nodes Opt test class"""
